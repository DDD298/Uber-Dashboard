...
const badgeVariants = cva(
  "inline-flex items-center border px-2 py-0.5 rounded-[6px] text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 cursor-pointer w-fit text-nowrap",
  {
    variants: {
      variant: {
        ...
        amber:
          "bg-amber-500 hover:bg-amber-600 text-white border-2 border-amber-100 text-nowrap flex items-center gap-1",
        yellow:
          "bg-yellow-500 hover:bg-yellow-600 text-white border-2 border-yellow-100 text-nowrap flex items-center gap-1",
        lime: "bg-lime-500 hover:bg-lime-600 text-white border-2 border-lime-100 text-nowrap flex items-center gap-1",
        green:
          "bg-green-500 hover:bg-green-600 text-white border-2 border-green-100 text-nowrap flex items-center gap-1",
        emerald:
          "bg-emerald-500 hover:bg-emerald-600 text-white border-2 border-emerald-100 text-nowrap flex items-center gap-1",
        ...
        indigo:
          "bg-indigo-500 hover:bg-indigo-600 text-white border-2 border-indigo-100 text-nowrap flex items-center gap-1",
        violet:
          "bg-violet-500 hover:bg-violet-600 text-white border-2 border-violet-100 text-nowrap flex items-center gap-1",
        purple:
          "bg-purple-500 hover:bg-purple-600 text-white border-2 border-purple-100 text-nowrap flex items-center gap-1",
        fuchsia:
          "bg-fuchsia-500 hover:bg-fuchsia-600 text-white border-2 border-fuchsia-100 text-nowrap flex items-center gap-1",
