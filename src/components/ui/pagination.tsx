  ...
  return (
    ...
    >
      <ul className="inline-flex items-center -space-x-px">
        <li>
          <button
            className="px-3 py-2 ml-0 leading-tight text-gray-700 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700"
        ...
        {getPages().map((p, index) => (
          <li key={typeof p === "number" ? p : `ellipsis-${index}`}>
            {p === "..." ? (
              <span className="px-3 py-2 leading-tight text-gray-700 bg-white border border-gray-300">
                ...
              </span>
            ) : (
              <button
        ...
        <li>
          <button
            className="px-3 py-2 leading-tight text-gray-700 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700"
            onClick={() => onPageChange(page + 1)}
